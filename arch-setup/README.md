...
- **Desktop Environment Tools**: hyprland-git, waybar-hyprland, wofi, dunst, alacritty, swaybg, hypridle, hyprlock, brightnessctl, pavucontrol, thunar, grim, slurp, network-manager-applet, gedit, xdg-desktop-portal-hyprland, polkit-gnome, qt6-wayland, xdotool, brave-bin.
