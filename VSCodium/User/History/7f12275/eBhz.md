...
```shell
yay -S hyprland-git waybar-hyprland wofi dunst kitty swaybg swayidle  brightnessctl pavucontrol thunar grim slurp network-manager-applet lf neovim cava btop neofetch pulseaudio x86-video-intel brave-bin xdg-desktop-portal-hyprland polkit-gnome qt6-wayland
```
...
```shell
yay -S docker docker-compose asdf-vm vscodium dbeaver postman-bin git-cola
```