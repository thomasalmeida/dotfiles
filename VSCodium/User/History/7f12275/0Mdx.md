...
```shell
yay -S hyprland-git waybar-hyprland wofi dunst kitty swaybg swayidle git vim brightnessctl pavucontrol thunar grim slurp network-manager-applet lf neovim cava btop neofetch gedit wget curl pulseaudio x86-video-intel brave-bin xdg-desktop-portal-hyprland polkit-gnome qt6-wayland
```
